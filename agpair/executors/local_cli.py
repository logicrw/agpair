...
class LocalCLIExecutor(ExecutorAdapter):
    ...
    def dispatch(
        ...
        *,
        ...
        contracted_body = body_with_task_contract(
            task_id,
            body,
            execution_repo_path=execution_repo_path,
...
""",
    ...
    def _extract_error_summary(self, temp_dir: pathlib.Path, max_chars: int = 500) -> str:
        ...
        if stderr_file.exists():
            ...
            clean_lines = [_strip_ansi(line) for line in lines[-20:] if line.strip()]
            if clean_lines:
        ...
        if stdout_file.exists():
            ...
            clean_lines = [_strip_ansi(line) for line in lines[-5:] if line.strip()]
            if clean_lines:
