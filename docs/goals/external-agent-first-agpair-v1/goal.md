...
- Likely misfire: completing only the planning/docs layer, or implementing only the CLI happy path while leaving MCP, daemon, wait, Codex/Claude hooks, legacy Gemini readability, docs, or privacy gates stale.
