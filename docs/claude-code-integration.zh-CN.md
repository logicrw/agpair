...
cp "/绝对路径/agpair/skills/Claude/SKILL.md" ~/.claude/skills/agpair/SKILL.md
```
...
- `skills/Claude/SKILL.md` 已把 `Monitor("agpair task watch <TASK_ID> --json")` 作为标准动作
